...
public final class ToolsInstaller {
    ...
    public int install() throws RootShellException, IOException {
        if (!context.getPackageName().startsWith("com.rostamvpn."))
            throw new SecurityException("The tools may only be installed system-wide from the main Rostam VPN app.");
