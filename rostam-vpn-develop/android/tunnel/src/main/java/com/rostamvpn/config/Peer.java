...
package com.rostamvpn.config;

import com.rostamvpn.config.BadConfigException.Location;
import com.rostamvpn.config.BadConfigException.Reason;
import com.rostamvpn.config.BadConfigException.Section;
...
public final class Peer {
     ...
     *
     * @param endpoint of type InetEndpoint
     */
    public void setEndpoint(InetEndpoint endpoint) {
